...
class getErrorControllerService extends phpDocumentor_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 6).'/symfony/http-kernel/Controller/ErrorController.php';
        include_once \dirname(__DIR__, 6).'/symfony/error-handler/ErrorRenderer/ErrorRendererInterface.php';
        include_once \dirname(__DIR__, 6).'/symfony/error-handler/ErrorRenderer/HtmlErrorRenderer.php';
