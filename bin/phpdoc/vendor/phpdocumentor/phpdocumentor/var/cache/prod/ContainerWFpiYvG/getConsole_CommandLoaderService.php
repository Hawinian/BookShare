...
class getConsole_CommandLoaderService extends phpDocumentor_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 6).'/symfony/console/CommandLoader/CommandLoaderInterface.php';
        include_once \dirname(__DIR__, 6).'/symfony/console/CommandLoader/ContainerCommandLoader.php';
